...
+(NSString*)getCurrentTimestamp{
    NSString * result = [NSString stringWithFormat:@"%lf",[[NSDate date] timeIntervalSince1970] * 1000];
...
+(NSString*)getTimestampFromDate:(NSDate*)date{
    NSString * result = [NSString stringWithFormat:@"%lf",[date timeIntervalSince1970] * 1000];
    result = [NSString stringWithFormat:@"%llu",[result longLongValue]];
    return result;
}
